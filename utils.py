    ...
    fig = go.Figure(
        go.Indicator(
            ...
            gauge={
                ...
                "bordercolor": "white",
                "steps": [
                    {"range": [0, 30], "color": "rgba(0,255,0,0.3)"},    # Green range
                    {"range": [30, 60], "color": "rgba(255,255,0,0.3)"},  # Yellow range
                    {"range": [60, 100], "color": "rgba(255,0,0,0.3)"},   # Red range
                ],
                "threshold": {
...
# Create a model probability bar chart
